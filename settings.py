...
CHANNELS_NAME     = ['Fp1','Fp2','F3','F4','C3',
                     'C4','P3','P4','O1','O2',
                     'F7','F8','T3','T4','T5',
                     'T6','Fz','Cz','Pz']
AVE_CHANNELS_NAME = ['Fp1-AVE', 'Fp2-AVE', 'F3-AVE','F4-AVE', 'C3-AVE',
                     'C4-AVE', 'P3-AVE', 'P4-AVE', 'O1-AVE', 'O2-AVE',
                     'F7-AVE', 'F8-AVE', 'T3-AVE', 'T4-AVE', 'T5-AVE',
                     'T6-AVE', 'Fz-AVE', 'Cz-AVE', 'Pz-AVE']

COL_DTYPE         = {chan:np.float32 for chan in AVE_CHANNELS_NAME}


DURATION          = 10          # Number of duration taken input and output
NORMALIZE_CONS_1  = 0.005
NORMALIZE_CONS_2  = 1.11
...
# total_sample = 6345+1358+1358
# num_spike    = 72
# ((total_sample-num_spike)*2)/(num_spike*2) = 124.85
LOSS_POS_WEIGHT       = torch.tensor([124.85])

MAX_COUNT_F1_SCORE    = 20         # Maximum count in not increasing in validation f1 score
